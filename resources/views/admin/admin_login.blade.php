...
<!-- Mirrored from codervent.com/rukada/demo/vertical/ltr/auth-cover-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:37:46 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
				...
				<div class="row g-0">
					...
					<div class="col-12 col-xl-7 col-xxl-8 auth-cover-left bg-gradient-cosmic align-items-center justify-content-center d-none d-xl-flex">
                        ...
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
							<div class="card-body">
                                 <img src="{{ asset('Admin') }}/assets/images/login-images/login-cover.svg" class="img-fluid auth-img-cover-login" width="650" alt=""/>
							</div>
						</div>
									...
									<div class="form-body">
										...
										<div class="row g-3">
											<div class="col-12">
												...
												<input type="email" class="form-control" name="email" id="email" placeholder="Enter Mail" required>
											</div>
											<div class="col-12">
