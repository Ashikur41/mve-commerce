        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="deal" style="background-image: url('{{ url('Frontend') }}/assets/imgs/banner/popup-1.png')">
                        <div class="deal-top">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li>
                                            <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/flag-fr.png" alt="" />Français</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/flag-dt.png" alt="" />Deutsch</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/flag-ru.png" alt="" />Pусский</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li>
                                            <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/flag-fr.png" alt="" />INR</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/flag-dt.png" alt="" />MBP</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/flag-ru.png" alt="" />EU</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    <a href='shop-compare.html'>
                                        <img class="svgInject" alt="Nest" src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-compare.svg" />
                                ...
                                <div class="header-action-icon-2">
                                    <a href='shop-wishlist.html'>
                                        <img class="svgInject" alt="Nest" src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-heart.svg" />
                                ...
                                <div class="header-action-icon-2">
                                    <a class='mini-cart-icon' href='shop-cart.html'>
                                        <img alt="Nest" src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-cart.svg" />
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href='shop-product-right.html'><img alt="Nest" src="{{ url('Frontend') }}/assets/imgs/shop/thumbnail-3.jpg" /></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href='shop-product-right.html'><img alt="Nest" src="{{ url('Frontend') }}/assets/imgs/shop/thumbnail-2.jpg" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
                ...
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-1.svg" alt="" />Milks and Dairies</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-2.svg" alt="" />Clothing & beauty</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-3.svg" alt="" />Pet Foods & Toy</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-4.svg" alt="" />Baking material</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-5.svg" alt="" />Fresh Fruit</a>
                                        </li>
                                    </ul>
                                    <ul class="end">
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-6.svg" alt="" />Wines & Drinks</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-7.svg" alt="" />Fresh Seafood</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-8.svg" alt="" />Fast food</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-9.svg" alt="" />Vegetables</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/icons/category-10.svg" alt="" />Bread and Juice</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="more_slide_open" style="display: none">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li>
                                                <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-1.svg" alt="" />Milks and Dairies</a>
                                            </li>
                                            <li>
                                                <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-2.svg" alt="" />Clothing & beauty</a>
                                            </li>
                                        </ul>
                                        <ul class="end">
                                            <li>
                                                <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-3.svg" alt="" />Wines & Drinks</a>
                                            </li>
                                            <li>
                                                <a href='shop-grid-right.html'> <img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-4.svg" alt="" />Fresh Seafood</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    <li class="hot-deals"><img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-hot.svg" alt="hot deals" /><a href='shop-grid-right.html'>Deals</a></li>
                                    <li>
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href='shop-product-right.html'><img src="{{ url('Frontend') }}/assets/imgs/banner/banner-menu.png" alt="Nest" /></a>
                    ...
                    <div class="hotline d-none d-lg-flex">
                        <img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-headphone.svg" alt="hotline" />
                    ...
                    <div class="header-action-right d-block d-lg-none">
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href='shop-wishlist.html'>
                                    <img alt="Nest" src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-heart.svg" />
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href='shop-product-right.html'><img alt="Nest" src="{{ url('Frontend') }}/assets/imgs/shop/thumbnail-4.jpg" /></a>
                                            </div>
                                            <div class="shopping-cart-title">
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-social-icon mb-50">
                    ...
                    <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-facebook-white.svg" alt="" /></a>
                    <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-twitter-white.svg" alt="" /></a>
                    <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-instagram-white.svg" alt="" /></a>
                    <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-pinterest-white.svg" alt="" /></a>
                    <a href="#"><img src="{{ url('Frontend') }}/assets/imgs/theme/icons/icon-youtube-white.svg" alt="" /></a>
                </div>
    ...
    <div id="preloader-active">
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                <div class="text-center">
                    <img src="{{ url('Frontend') }}/{{ url('Frontend') }}/assets/imgs/theme/loading.gif" alt="" />
                </div>
            </div>
        </div>
    </div>
