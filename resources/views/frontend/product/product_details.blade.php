                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="product-price primary-color float-left">
                                    <span class="current-price text-brand" id="selling_price">&#2547;{{ $product->selling_price }}</span>
                                </div>
                                @else
                                <div class="product-price primary-color float-left">
                                ...
                                <div class="attr-detail attr-size mb-30">
                                    ...
                                    <select name="dsize" class="form-control uppercase-form-control" id="dsize">
                                        @foreach ($product->productSize as $size)
                                        <option value="{{ $size->id }}" {{$size->id ? 'selected':''  }}>{{ ucwords($size->product_size) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @else
                                <div class="attr-detail attr-size mb-30">
                                    ...
                                    <select class="form-control uppercase-form-control" id="dsize">
                                        ...
                                        @foreach ($product->productSize as $size)
                                        <option value="{{ $size->id }}">{{ ucwords($size->product_size) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @endif
