                                ...
                                <div class="detail-info pr-30 pl-30">
                                        ...
                                        @if ($product->discount_price == null)
                                            <div class="product-price primary-color float-left">
                                                <span class="current-price text-brand"
                                                    id="selling_price">&#2547;{{ $product->selling_price }}</span>
                                            </div>
                                        @else
                                            <div class="product-price primary-color float-left">
                                                <span
                                    ...
                                    @if ($product->product_size == null)
                                        <div class="attr-detail attr-size mb-30">
                                            ...
                                            <select name="dsize" class="form-control uppercase-form-control"
                                                id="dsize">
                                                @foreach ($product->productSize as $size)
                                                    <option value="{{ $size->id }}" {{ $size->id ? 'selected' : '' }}>
                                                        {{ ucwords($size->product_size) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    @else
                                        <div class="attr-detail attr-size mb-30">
                                            <strong class="mr-10" style="width: 50px;">Size : </strong>
                                            <select class="form-control uppercase-form-control" id="dsize">
                                                <option selected disabled>--Choose Size</option>
                                                @foreach ($product->productSize as $size)
                                                    <option value="{{ $size->id }}">{{ ucwords($size->product_size) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    @else
                                        <div class="attr-detail attr-size mb-30">
                                            ...
                                            <select class="form-control uppercase-form-control" id="dcolor">
                                    ...
                                    <div class="detail-extralink mb-50">
                                        <div class="detail-qty border radius">
                                            ...
                                            <input type="text" name="quantity" id="dqty" class="qty-val"
                                                value="1" min="1">
                                    ...
                                    <div class="font-xs">
                                        ...
                                        <ul class="float-start">
                                            ...
                                            <li>Stock:<span
                                                    class="in-stock text-brand ml-5">({{ $product->product_qty }})Items In
                                                    Stock</span></li>
                                        </ul>
                                    </div>
                                </div>
