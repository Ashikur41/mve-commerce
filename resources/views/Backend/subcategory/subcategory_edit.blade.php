					...
					<div class="main-body">
						<div class="row">
							<div class="col-lg-10">
								<div class="card">
									<div class="card-body">
                                        <form id="myForm" method="post" action="{{ route('update.sub_category') }}">
                                            @csrf
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-sm-9 text-secondary">
                                                    ...
                                                    @foreach ($category as $categorys)
                                                        <option value="{{ $categorys->id }}" {{ $categorys->id == $subcategory->category_id ? 'selected' : '' }}>{{ $categorys->category_name }}</option>
                                                    @endforeach
                                                    </select>
                                                </div>
                                            </div>
