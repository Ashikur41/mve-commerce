								...
								<div class="card">
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="form-group col-sm-9 text-secondary">
												<textarea class="form-control" name="post_short_description" id="post_short_description" rows="3"></textarea>
											</div>
										</div>
										...
										<div class="row mb-3">
											...
											<div class="form-group col-sm-9 text-secondary">
												<textarea class="form-control" name="post_long_description" id="post_long_description" rows="3"></textarea>
											</div>
										</div>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<img id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="post_image" style="width: 100px; hight:100px;">
											</div>
										</div>
										<div class="row">
